...
# Severity-keyword styles for `diagnostic` (design §4): error=red, warning=amber, note=blue.
_SEVERITY_STYLE = {
...
def diagnostic(
    ...
    *,
    ...
    """Render one cargo/uv-style diagnostic (design §4).
...
def resource_table(
    ...
    *,
    ...
    # Dim, uppercase headers; columns size to content so they always line up (design §6).
...
def success(
    ...
    *,
    ...
    """A green success panel with optional details and a Next step(s) list (design §5).

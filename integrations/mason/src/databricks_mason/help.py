...
_EXAMPLES: dict[CommandPath, tuple[str, ...]] = {
    ...
    ("memory", "bind"): ("mason memory bind agent-memory --source .",),
    ("memory", "unbind"): ("mason memory unbind --source .",),
    ...
    ("sessions", "bind"): ("mason sessions bind agent-sessions --source .",),
    ("sessions", "unbind"): ("mason sessions unbind --source .",),

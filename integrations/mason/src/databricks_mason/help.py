...
_EXAMPLES: dict[CommandPath, tuple[Example, ...]] = {
    (): (
        ("mason login --profile my-workspace", "authenticate and save a default profile"),
    ...
    ("login",): (("mason login --profile my-workspace", "save a profile as your default"),),
    ...
    ("memory",): (
        ("mason memory stores list", "list managed memory stores"),
        ("mason memory entries search --help", "see how to search entries"),
    ),
    ...
    ("deployments", "get"): (("mason deployments get my-agent", "show one deployment"),),
    ("deployments", "logs"): (("mason deployments logs my-agent", "stream a deployment's logs"),),
    ("deployments", "start"): (("mason deployments start my-agent", "start a deployment"),),
    ("deployments", "stop"): (("mason deployments stop my-agent", "stop a deployment"),),
    ("deployments", "delete"): (("mason deployments delete my-agent", "delete a deployment"),),
    ("tools",): (

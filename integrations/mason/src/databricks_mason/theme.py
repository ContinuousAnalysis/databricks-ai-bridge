...
Ports the palette and — more importantly — the color *rules* from the CLI facelift design
(Evie Xu, "Mason CLI: Facelifting Design Decisions"). Color carries meaning, never decoration:
...
Terminal reality: the design's hexes are tuned for a dark terminal (its mock sits on a #0d1117
background). A terminal is not a web page — we cannot set the background, and a forced light-grey
...
MASON_THEME = Theme(
    {
        ...
        "mason.llm": PURPLE,
        "mason.info": STEEL,
        # Severity keywords (design §4/§5): `error:` red, `warning:` amber, `note:` blue.

...
def main() -> None:
    ...
    parser.add_argument("--app", required=True, help="Full mason-prefixed deployment name")
    ...
    store_id = lakebase_durability_store.runtime_store_id(args.app, app.service_principal_client_id)
    resource = api.get_runtime_store(store_id)
    backend = lakebase_durability_store.backend_from_api(

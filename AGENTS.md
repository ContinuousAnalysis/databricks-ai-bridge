...
- **`databricks-mason`** -- distributes the Agent Bricks CLI (`ab`), AgentKit SDK (`databricks_agentkit`), and agent runtime. See [`integrations/mason/README.md`](integrations/mason/README.md) for the dev loop
...
integrations/mason/                # Agent Bricks CLI and AgentKit SDK (databricks-mason distribution)
